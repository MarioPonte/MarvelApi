...
async function showModal(clickedElement){
    ...
    document.getElementById("modalHero").innerHTML = '<div class="modal-dialog modal-lg"><div class="modal-content"> <div class="modal-header"> <h5 id="modalHeroName" class="modal-title">' + pegueiDadosModal.data.results[clickedElement].title + '</h5> <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button> </div> <div class="modal-body"> <strong><p>Price:</strong> ' + pegueiDadosModal.data.results[clickedElement].prices[0].price + '$</p> <p><strong>Creators:</strong> ' + allCreators + '</p> </div> <div class="heroHistory"> <button type="button" class="btn btn-primary btnInfoHero" data-bs-toggle="collapse" data-bs-target="#collapseComics" aria-expanded="false" aria-controls="collapseComics">Comics</button> <button type="button" class="btn btn-primary btnInfoHero" data-bs-toggle="collapse" data-bs-target="#collapseSeries" aria-expanded="false" aria-controls="collapseSeries">Series</button> <button type="button" class="btn btn-primary btnInfoHero" data-bs-toggle="collapse" data-bs-target="#collapseStories" aria-expanded="false" aria-controls="collapseStories">Stories</button> <button type="button" class="btn btn-primary btnInfoHero" data-bs-toggle="collapse" data-bs-target="#collapseEvents" aria-expanded="false" aria-controls="collapseEvents">Events</button> <div class="collapse" id="collapseComics"> <div class="card card-body"> <ul> Oi 1 </ul> </div> </div> <div class="collapse" id="collapseSeries"> <div class="card card-body"> <ul> Oi 2 </ul> </div> </div> <div class="collapse" id="collapseStories"> <div class="card card-body"> <ul> Oi 3 </ul> </div> </div> <div class="collapse" id="collapseEvents"> <div class="card card-body"> <ul> Oi 4 </ul> </div> </div> </div> </div> </div>';
