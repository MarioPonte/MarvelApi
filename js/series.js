...
const url = "https://gateway.marvel.com/v1/public/series?apikey=13211d1e170e426bd4688717129310e6&ts=1&hash=95520260e855ed5e627a8f270f9c9505";
...
async function getDados() {
    ...
    for(var i=0; i<(pegueiDados.data.results).length; i++){
        $('#infoSection').append('<div id="' + i + '" class="heroInfo" onclick="showModal(' + i + ')"><img src="' + pegueiDados.data.results[i].thumbnail.path + '.' + pegueiDados.data.results[i].thumbnail.extension + '" alt="" srcset="" class="heroImg"></div>');
    }
...
function searchUrl(){
    ...
    return "https://gateway.marvel.com/v1/public/series?titleStartsWith=" + inputValue + "&ts=1&hash=95520260e855ed5e627a8f270f9c9505&apikey=13211d1e170e426bd4688717129310e6";
}
...
async function searchData() {
    ...
    for(var i=0; i<(searchPegueiDados.data.results).length; i++){
        $('#infoSectionSearch').prepend('<div id="' + i + '" class="heroInfo" onclick="showModal(' + i + ')"><img src="' + searchPegueiDados.data.results[i].thumbnail.path + '.' + searchPegueiDados.data.results[i].thumbnail.extension + '" alt="" srcset="" class="heroImg"></div>');
    }
}
